...
document.querySelector('#recommend-btn-users').addEventListener('click', RecommendedJobsNew);
...
//   $("#jobWallLeft").append(divItem);
  ...
  $('#recommend-btn-users').on('click', getCollabRecommendedJobs);
}
...
function getCollabRecommendedJobs()
{
    ...
    apigClient.getcollaborativerecsPost(params, body, additionalParams).then(function(result)
    {
        console.log(result);
